const { PhloMultiPartyCallMember, PhloMultiPartyCallMemberInterface } = require('./phloMultiPartyCallMember');
...
class UpdateMultipartyCallResponse {
    constructor(params) {
        params = params || {};
...
class RetrieveMultipartyCallResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class PhloMultiPartyCall extends VobizResource {
    ...
    update(action, triggerSource, to, role) {
        ...
        // https://phlorunnner.vobiz.com/v1/phlo/{phlo_id}/{node_type}/{node_id} 
...
class PhloMultiPartyCallInterface extends VobizResourceInterface {
...
module.exports = {
  UpdateMultipartyCallResponse,
  RetrieveMultipartyCallResponse,
  PhloMultiPartyCall,
