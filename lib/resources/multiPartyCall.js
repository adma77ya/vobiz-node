...
const {VobizResource, VobizResourceInterface, VobizSecondaryResource} = require('../base');
const { validSubAccount, validUrl, validParam, validDateFormat, validRange, validMultipleDestinationNos, validMultipleDestinationIntegers, isOneAmongStringUrl, multiValidParam, InvalidRequestError } = require('../rest/utils');
...
class MultiPartyCall extends VobizResource{
...
class MultiPartyCallParticipant extends VobizSecondaryResource{
  constructor(client, data = {}) {
...
class MultiPartyCallMember extends VobizSecondaryResource{
  constructor(client, data= {}) {
...
class MultiPartyCallInterface extends VobizResourceInterface{
  constructor(client, data = {}) {
    super(action, MultiPartyCall, idField, client);
    extend(this, data);
...
module.exports = {
  ...
  MultiPartyCallMember,
  MultiPartyCallInterface
};
