...
class StartRecordingConferenceResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;
...
class RetrieveConferenceResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class ListAllConferenceResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class Conference extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class ConferenceInterface extends VobizResourceInterface {
...
module.exports = {
  MuteMemberResponse,
  StartRecordingConferenceResponse,
  RetrieveConferenceResponse,
  ListAllConferenceResponse,
  SpeakMemberResponse,
  PlayAudioMemberResponse,
  DeafMemberResponse,
  Conference,
  ConferenceInterface
};
