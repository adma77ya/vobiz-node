 ...
 */
class Profile extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class ProfileInterface extends VobizResource {
    constructor(client, data = {}) {
        super(action, Profile, idField, client);
        extend(this, data);
        this[clientKey] = client;
     ...
     */
    create(profile_alias,vobiz_subaccount,customer_type,entity_type, company_name,ein,vertical,ein_issuing_country,stock_symbol,stock_exchange, alt_business_id_type, website, address, authorized_contact, business_contact_email){
        let params = {}
        params.profile_alias=profile_alias;
        params.vobiz_subaccount=vobiz_subaccount;
