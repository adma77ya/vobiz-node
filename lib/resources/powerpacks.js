...
class RemoveTollFreeNumberResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.response = params.response;
...
class AddTollFreeNumberresponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.accountPhoneNumberResource = params.accountPhoneNumberResource;
...
class RetrieveTollFreeResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.accountPhoneNumberResource = params.accountPhoneNumberResource;
...
class RetrieveShortCodeResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.addedOn = params.addedOn;
 ...
 */
class Powerpack extends VobizResource {
...
class NumberPool extends VobizResource {
    constructor(client, data = {}) {
...
class Numbers extends VobizResource {
    constructor(client, data = {}) {
...
class Shortcode extends VobizResource {
    constructor(client, data = {}) {
...
class Tollfree extends VobizResource {
    constructor(client, data = {}) {
 ...
 * @param {object} [data] - data of call
 */
class PowerpackInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, Powerpack, idField, client);
        extend(this, data);
        this[clientKey] = client;
...
module.exports = {
  ListAllNumbersResponse,
  CreatePowerpackResponse,
  UpdatePowerpackResponse,
  ListShortCodeResponse,
  ListTollFreeResponse,
  AddNumberResponse,
  RemoveNumberResponse,
  RemoveTollFreeNumberResponse,
  RemoveShortCodeResponse,
  AddTollFreeNumberresponse,
  RetrieveNumberResponse,
  RetrieveTollFreeResponse,
