...
class EndUser extends VobizResource {
 ...
 */
class EndUserInterface extends VobizResourceInterface {
...
module.exports = {
  EndUsersResponse,
  CreateEndUsersResponse,
  ListEndUsersResponse,
  UpdateEndUsersResponse,
  EndUser,
  EndUserInterface
};
