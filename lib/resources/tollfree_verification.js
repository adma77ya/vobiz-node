...
class GetTollfreeVerificationResponse {
constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
	    this.uuid = params.uuid;
...
class TollfreeVerification extends VobizResource {
     ...
     * @param {string} [params.profile_uuid] - The unique identifier of an existing Vobiz profile. 
 ...
 */
class TollfreeVerificationInterface extends VobizResourceInterface {
...
module.exports = {
  ...
  CreateTollfreeVerificationResponse,
  GetTollfreeVerificationResponse,
