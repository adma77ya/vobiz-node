...
class StartPlayingMusicResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;
...
class StartSpeakingTextResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;
 ...
 */
class Call extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class CallInterface extends VobizResourceInterface {
    ...
    create(from, to, answerUrl, params = {}) {
        ...
        params.answerMethod = params.answerMethod || 'POST';
        params.isVoiceRequest = 'true';
...
class LiveCallResource extends VobizResource {
    constructor(client, data = {}) {
...
class QueuedCallResource extends VobizResource {
    constructor(client, data = {}) {
 ...
 * @param {object} [data] - data of call
 */
class LiveCallInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, LiveCallResource, idField, client);
        extend(this, data);
 ...
 * @param {object} [data] - data of call
 */
class QueuedCallInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, QueuedCallResource, idField, client);
        extend(this, data);
...
module.exports = {
  ...
  ListAllQueuedCalls,
  ListAllLiveCallResponse,
  CreateCallResponse,
  GetQueuedCallResponse,
  GetLiveCallResponse,
  RetrieveCallResponse,
  ListAllCallsResponse,
  StartPlayingMusicResponse,
  StartSpeakingTextResponse,
  SendDigitsResponse,
  RecordCallResponse,
  StartStreamResponse,
  Call,
