const _ = require('lodash');const { VobizGenericResponse, VobizResource, VobizResourceInterface } = require('../base');
 ...
 */
class Media extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class MediaInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, Media, idField, client);
        extend(this, data);
            ...
            client('GET', action, params)
                .then(response => {
                    ...
                    response.body.objects.forEach(item => {
                        objects.push(new VobizGenericResponse(item, client));
                    });
                    resolve(objects);
                })
                .catch(error => {
