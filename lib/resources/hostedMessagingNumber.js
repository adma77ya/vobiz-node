...
class HostedMessagingNumberResponse {
  constructor(params) {
    params = params || {};
...
class CreateHostedMessagingNumberResponse {
  constructor(params) {
    params = params || {};
    this.apiId = params.apiId;
    this.alias = params.alias;
...
class ListHostedMessagingNumberResponse {
  constructor(params) {
    params = params || {};
    this.apiId = params.apiId;
...
class HostedMessagingNumber extends VobizResource {
 ...
 */
class HostedMessagingNumberInterface extends VobizResourceInterface {
  constructor(client, data = {}) {
    super(action, HostedMessagingNumber, idField, client);
    extend(this, data);
    this[clientKey] = client;
...
module.exports = {
  HostedMessagingNumberResponse,
  CreateHostedMessagingNumberResponse,
  ListHostedMessagingNumberResponse,
  HostedMessagingNumber,
  HostedMessagingNumberInterface
};
