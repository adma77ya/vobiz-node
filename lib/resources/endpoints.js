...
class RetrieveEndpointResponse {
  constructor(params) {
      params = params || {};
      this.apiId = params.apiId;
      this.alias = params.alias;
...
*/
class Endpoint extends VobizResource {
...
* @param {object} [data] - data of call
*/
class EndpointInterface extends VobizResourceInterface {
