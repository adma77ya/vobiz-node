...
class CreateMaskingSessionResponse {
    constructor(params) {
        params = params || {};
...
class GetMaskingSessionResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class DeleteMaskingSessionResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;        
...
class UpdateMaskingSessionResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message; 
...
class ListMaskingSessionResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.response = params.response;   
...
class MaskingSession extends VobizResource {
...
class MaskingSessionInterface extends VobizResourceInterface {
	 ...
	 * @param {string} [params.secondPartyPlayUrl] - The URL to play audio to the second party when the call is established.
	 * @param {string} [params.recordingCallbackMethod] - The HTTP method for the recording callback request.
	 * @returns {Promise<VobizGenericResponse>} - Resolves to a VobizGenericResponse object
...
module.exports = {
  CreateMaskingSessionResponse,
  GetMaskingSessionResponse,
  DeleteMaskingSessionResponse,
  UpdateMaskingSessionResponse,
  ListMaskingSessionResponse,
  MaskingSession,
