...
const CALLINSIGHTS_BASE_URL = 'https://stats.vobiz.ai/'
class CallFeedback extends VobizResource {
 ...
 */
class CallFeedbackInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
