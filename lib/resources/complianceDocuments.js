...
class CreateComplianceDocumentResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.documentTypeId = params.documentTypeId;
...
class ListComplianceDocumentsResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class UpdateComplianceDocumentResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;
...
class ComplianceDocument extends VobizResource {
 ...
 */
class ComplianceDocumentInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, ComplianceDocument, idField, client);
        extend(this, data);
        this[clientKey] = client;
...
module.exports = {
  ...
  CreateComplianceDocumentResponse,
  ListComplianceDocumentsResponse,
  UpdateComplianceDocumentResponse,
  ComplianceDocument,
