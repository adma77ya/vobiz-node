 ...
 */
class Message extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class MessageInterface extends VobizResourceInterface {
    constructor(client, data = {}) {
        super(action, Message, idField, client);
        extend(this, data);
        this[clientKey] = client;
     ...
     * @param {string} [optionalParams.log] If set to false, the content of this message will not be logged on the Vobiz infrastructure and the dst value will be masked (e.g., 141XXXXX528),if set to content_only only number will be masked, if set to number_only only text would be masked .Default is set to true.
     ...
     * @promise {object} return {@link VobizGenericMessage} object if success
