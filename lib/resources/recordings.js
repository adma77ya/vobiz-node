...
class RetrieveRecordingResponse {
  constructor(params) {
      params = params || {};
...
*/
class Recording extends VobizResource {
...
* @param {object} [data] - data of call
*/
class RecordingInterface extends VobizResourceInterface {
  ...
  export(params = {}) {
      ...
      return new Promise((resolve, reject) => {
          this[clientKey]('POST', 'export/recording/', requestParams)
              .then(response => {
  ...
  bulkDelete(params = {}) {
      let requestParams = Object.assign({}, params);
      return new Promise((resolve, reject) => {
          this[clientKey]('DELETE', 'Recording/BulkDelete/', requestParams)
              .then(response => {
                  resolve(response.body);
              })
              .catch(error => {
