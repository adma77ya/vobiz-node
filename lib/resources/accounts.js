...
class Subaccount extends VobizResource {
 ...
 * @param {object} [data] - data of call
 */
class SubaccountInterface extends VobizResourceInterface {
 ...
 * @promise {VobizGenericResponse} return object of VobizGenericObject
 * @fail {Error} return Error
 */
  create(name, enabled) {
    let params = {};
 ...
 * @param {object} [data] - data of call
 */
class Account extends VobizResource {
  constructor(client, data = {}) {
 ...
 * get account detail
 * @method
 * @promise {VobizGenericResponse} return VobizGenericResponse object
 * @fail {Error} return Error
 */
get() {
 ...
 * @param {object} [data] - data of call
 */
class AccountInterface extends VobizResourceInterface {
  constructor(client, data = {}) {
    super(action, Account, idField, client);
    extend(this, data);
