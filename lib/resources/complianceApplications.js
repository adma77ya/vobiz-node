...
class ComplianceApplicationResponse {
    constructor(params) {
        params = params || {};
...
class CreateComplianceApplicationResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.complianceApplicationId = params.complianceApplicationId;
...
class ListComplianceApplicationResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
...
class UpdateComplianceApplicationResponse {
    constructor(params) {
        params = params || {};
        this.apiId = params.apiId;
        this.message = params.message;
...
class ComplianceApplication extends VobizResource {
 ...
 */
class ComplianceApplicationInterface extends VobizResourceInterface {
...
module.exports = {
  ComplianceApplicationResponse,
  CreateComplianceApplicationResponse,
  ListComplianceApplicationResponse,
  UpdateComplianceApplicationResponse,
  ComplianceApplication,
  ComplianceApplicationInterface
};
