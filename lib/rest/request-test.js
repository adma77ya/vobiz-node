...
function Request(config) {
  ...
  return (method, action, params) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        resolve({
          ...
          body: {
            ...
            "session": {
                ...
                "session_uuid": "197aa6e0-1abe-4d1c-b887-2b2406764360",
                "callback_url": "http://vobizbin.non-prod.vobizps.com/1jvpmrs1",
                "callback_method": "GET",
                ...
                "ring_timeout": 120,
                "first_party_play_url": "https://s3.amazonaws.com/vobizsamplexml/play_url.xml",
                "second_party_play_url": "https://vobizbin-prod-usw.vobizps.com/api/v1/speak.xml",
                "record": false,
                "record_file_format": "mp3",
                "recording_callback_url": "https://vobizbin-prod-usw.vobizps.com/api/v1/speak.xml",
                ...
                "interaction": [
                    {
                        ...
                        "first_party_resource_url": "https://api-qa.voice.vobizdev.com/v1/Account/MAZTQXZDYWNZBMMJAZZJ/Call/46bca3f0-e9de-4fa9-a0fc-fff28171527c",
                        "type": "call",
                        "total_call_count": 1,
                        "duration": 0
                    }
      ...
      // =============  Application ===================
        ...
        resolve({
          ...
          body: {
            ...
            sip_uri: 'sip:20372631212782780@app.vobiz.com',
            sub_account: null
          }
        });
      }
          ...
          body: {
            ...
            objects: [
              ...
              },
              {
                ...
                sip_uri: 'sip:142606239271920703@app.vobiz.com',
                sub_account: null
              }
            ]
          }
      ...
      // ============= MultiPartyCalls ===============
        ...
        resolve({
          ...
          body: {
            ...
            "calls": [
              {
                "to": "sip:koushikqa119062465586783372208@phone-qa.voice.vobizdev.com",
                "from": "918888888888",
        ...
        resolve({
          ...
          body: {
            ...
            "recording_url" : "https://media-qa.voice.vobizdev.com/v1/Account/MAMDJMMTEZOWY0ZMQWM2/Recording/e9bd7634-ee0a-11ea-9ddf-06feebbe3347.mp3"
          }
        });
      }
        ...
        resolve({
          ...
          body: {
            ...
            "recording_url": "https://media-qa.voice.vobizdev.com/v1/Account/MAXXXXXXXXXXXX/Recording/XXXXX-XXXX-XXXX-XXXXX.mp3"
          }
        });
      }
      ...
      // =============  Endpoint ===================
        ...
        resolve({
          ...
          body: {
            ...
            sip_uri: 'sip:zumba141009125224@phone.vobiz.com',
            sub_account: null,
            ...
            objects: [
              {
                ...
                sip_registered: 'true',
                sip_uri: 'sip:callme140703093944@phone.vobiz.com',
              ...
              },
              {
                ...
                sip_registered: 'false',
                sip_uri: 'sip:polycom140506175228@phone.vobiz.com',
                sub_account: null,
      ...
      else if (method == 'POST' && action == 'Verify/Session/') {
          resolve({
            response: {},
            body: {
              message: 'Session initiated',
              session_uuid: 'db3ce55a-7f1d-11e1-8ea7-1231380bc196',
              api_id: 'db342550-7f1d-11e1-8ea7-1231380bc196'
            }
          });
        }

      else if (method == 'GET' && action == 'Verify/Session/1/') {
        resolve({
          response: {},
          body: {
            api_id: 'c3f2f101-ff46-44dd-808a-00408deba5d1',
            session_uuid: 'd8f1b187-ddcb-438a-a298-eb17fb2b31f5',
            app_uuid: '3cdec449-a367-435e-b4f9-40d777a7cfcc',
            alias: 'new_voice45',
            recipient: '918707046406',
            channel: 'sms',
            status: 'verified',
            count: 1,
            requestor_ip: '',
            ...
            attempt_details: [
              {
                channel: 'sms',
                attempt_uuid: 'e2f66aeb-6b98-42a9-ba81-0aba74a7eb7c',
                status: 'delivered',
                time: '2023-07-24T22:47:21.279363+05:30'
              }
            ],
            charges: {
              total_charge: '0.07100',
              validation_charge: '0.05',
              attempt_charges: [
                {
                  attempt_uuid: 'e2f66aeb-6b98-42a9-ba81-0aba74a7eb7c',
                  channel: 'sms',
            ...
            created_at: '2023-07-24T22:47:19.243437+05:30',
            updated_at: '2023-07-24T22:47:21.279363+05:30'
          }
        })
        }

      else if (method == 'GET' && action == 'Verify/Session/') {
          resolve({
            response: {},
            body: {
              api_id: 'c3f2f101-ff46-44dd-808a-00408deba5d1',
              ...
              sessions:[{session_uuid: 'd8f1b187-ddcb-438a-a298-eb17fb2b31f5',
                app_uuid: '3cdec449-a367-435e-b4f9-40d777a7cfcc',
                alias: 'new_voice45',
                recipient: '918707046406',
                channel: 'sms',
      ...
      else if (method == 'POST' && action == 'Verify/Session/1/') {
          resolve({
            response: {},
            body: {
      ...
      // =========== TollfreeVerification Methods ============================
      else if (method == 'POST' && action == 'TollfreeVerification/') {
        resolve({
          response: {},
          body: {
            message: 'created',
      ...
      } else if (method == 'GET' && action == 'TollfreeVerification/') {
        resolve({
          response: {},
          body: {
            ...
            "meta": {
              "total_count": 10,
              "limit": 3,
              "next":  "/v1/Account/MAXXXXXXXXXXXXXXXXXX/TollfreeVerification/?limit=3&offset=3",
              "offset": 0,
              "previous": null
            },
            "objects": [
              {
                ...
                "extra_data": "",
                "message_sample": "1.Your Vobiz verification code is xxxx. 2.Dear <customer name>, you have signed up on Vobiz successfully.",
                "number": "18449605287",
                "optin_image_url": "https://www.vobiz.com",
                "optin_type": "MOBILE_QR_CODE",
                "profile_uuid": "0ead82e0-fc80-4dc3-888b-XXXXXXXXXXXX",
                "error_message": "Demo Testing",
                "status": "REJECTED",
                "last_modified": "2023-10-13T08:24:26.619565Z",
                "usecase": "2FA",
                "usecase_summary": "1.We send 2FA codes to customers when they signup. 2.Dear <customer name>, you have signed up on Vobiz successfully.",
              ...
              },
              {
                ...
                "usecase": "2FA",
                "usecase_summary": "1.We send 2FA codes to customers when they signup. 2.Dear <customer name>, you have signed up on Vobiz successfully.",
                "uuid": "96ec880d-XXXX-XXXX-XXXX-XXXXXXXXXXXX",
                "volume": "100"
              }
            ]
          }
        });                                 
      }  else if (method == 'GET' && action == 'TollfreeVerification/1/') {
        resolve({
          response: {},
          body: {
            additionalInformation: '',
            api_id: 'cb715662-7d74-11ee-acc0-0242ac110007',
            callbackMethod: 'POST',
            callbackUrl: 'http://callback_url',
            created: '2023-11-07T08:10:57.43719Z',
            errorMessage: 'Unknown error. Please contact support.',
            extraData: '',
            lastModified: '2023-11-07T08:11:01.398865Z',
            messageSample: '1.Your Vobiz verification code is xxxx. 2.Dear <customer name>, you have signed up on Vobiz successfully.',
            number: '18339431490',
            optinImageUrl: 'https://www.vobiz.com',
            optinType: 'MOBILE_QR_CODE',
            profileUuid: '42f92135-6ec2-4110-8da4-XXXXXXXXXXXX',
            status: 'REJECTED',
            usecase: '2FA',
            usecaseSummary: '1.We send 2FA codes to customers when they signup. 2.Dear <customer name>, you have signed up on Vobiz successfully.',
            uuid: 'XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX',
            volume: '100'
          }
        });                                 
      } else if (method == 'POST' && action == 'TollfreeVerification/1/') {
        resolve({
          response: {},
          body: {
            message: 'Tollfree verification request for 18XXXXXXXXX updated succesfully',
            api_id: 'db342550-7f1d-11e1-8ea7-1231380bc196'
          }
        });                                 
      } else if (method == 'DELETE' && action == 'TollfreeVerification/1/') {
        resolve({
          response: {},
          body: {
            response: {},
