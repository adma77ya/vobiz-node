...
function AccessToken(authId, authToken, username, validityOptions = {}, uid = null) {
  this.authId = authId || process.env.VOBIZ_AUTH_ID;
  this.key = authToken || process.env.VOBIZ_AUTH_TOKEN;
